        # Kanban Lab: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/kanban-lab.git

        ## Objective

        Kanban Lab is a meta-analysis research tool for evidence synthesis.
        ...
        - Code: https://github.com/mahmood726-cyber/kanban-lab.git
        - Dashboard: https://mahmood726-cyber.github.io/kanban-lab/
